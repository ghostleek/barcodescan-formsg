!function(){var t,e,i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},s={},r=i.parcelRequirea202;null==r&&((r=function(t){if(t in o)return o[t].exports;if(t in s){var e=s[t];delete s[t];var i={id:t,exports:{}};return o[t]=i,e.call(i.exports,i,i.exports),i.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){s[t]=e},i.parcelRequirea202=r);var n=r.register;n("bkcP3",function(t,e){t.exports=r("4WKyX")(r("iE7OH").resolve("iqysf")).then(()=>r("dZsGG"))}),n("4WKyX",function(t,e){var i=r("2prpb");t.exports=i(function(t){return new Promise(function(e,i){if([].concat(document.getElementsByTagName("script")).some(function(e){return e.src===t})){e();return}var o=document.createElement("link");o.href=t,o.rel="preload",o.as="script",document.head.appendChild(o);var s=document.createElement("script");s.async=!0,s.type="text/javascript",s.src=t,s.onerror=function(e){var o=TypeError("Failed to fetch dynamically imported module: ".concat(t,". Error: ").concat(e.message));s.onerror=s.onload=null,s.remove(),i(o)},s.onload=function(){s.onerror=s.onload=null,e()},document.getElementsByTagName("head")[0].appendChild(s)})})}),n("2prpb",function(t,e){var i={},o={},s={};t.exports=function(t,e){return function(r){var n=function(t){switch(t){case"preload":return o;case"prefetch":return s;default:return i}}(e);return n[r]?n[r]:n[r]=t.apply(null,arguments).catch(function(t){throw delete n[r],t})}}});let a=(t="",e="")=>{let i=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${i}${"string"==typeof e&&""!==e?"-"+e:""}`},l=(t,e)=>{if(Object.prototype.hasOwnProperty.call(e,t)){let i=e[t];delete e[t],e[t]=i}},d=0,c=`
  :host {
...
`;class j extends HTMLElement{#e=null;#t=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild($.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.getElementById("file-input"),this.#t=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(t,e,i){"accept"===t&&e!==i&&this.#e&&(this.#e.accept=this.accept),"disabled"===t&&e!==i&&this.#e&&(this.#e.disabled=this.disabled,this.disabled?(this.#t?.removeAttribute("tabindex"),this.#t?.setAttribute("aria-disabled","true")):(this.#t?.setAttribute("tabindex","0"),this.#t?.setAttribute("aria-disabled","false"))),"multiple"===t&&e!==i&&this.#e&&(this.#e.multiple=this.multiple)}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("autoFocus"),this.#s("noStyle"),this.#e?.addEventListener("change",this.#n),this.#t?.addEventListener("dragenter",this.#a),this.#t?.addEventListener("dragover",this.#o),this.#t?.addEventListener("dragleave",this.#l),this.#t?.addEventListener("drop",this.#i),this.#t?.addEventListener("click",this.#c),this.#t?.addEventListener("keyup",this.#r),this.autoFocus&&this.#t?.focus()}disconnectedCallback(){this.#e?.removeEventListener("change",this.#n),this.#t?.removeEventListener("dragenter",this.#a),this.#t?.removeEventListener("dragover",this.#o),this.#t?.removeEventListener("dragleave",this.#l),this.#t?.removeEventListener("drop",this.#i),this.#t?.removeEventListener("click",this.#c),this.#t?.removeEventListener("keyup",this.#r)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get maxFiles(){let t=Number(this.getAttribute("max-files"))||0;return t<=0?1/0:Math.floor(Math.abs(t))}set maxFiles(t){this.setAttribute("max-files",null!=t?t.toString():t)}get maxSize(){let t=this.getAttribute("max-size");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set maxSize(t){this.setAttribute("max-size",null!=t?t.toString():t)}get minSize(){let t=this.getAttribute("min-size");if(null===t)return 0;let e=Number(t);return Number.isNaN(e)?0:e}set minSize(t){this.setAttribute("min-size",null!=t?t.toString():t)}get multiple(){return this.hasAttribute("multiple")}set multiple(t){this.toggleAttribute("multiple",!!t)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(t){this.toggleAttribute("auto-focus",!!t)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(t){this.toggleAttribute("no-style",!!t)}#n=async t=>{try{this.#b(await I(t))}catch(t){this.dispatchEvent(new CustomEvent(`${B}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}};#a=()=>{this.disabled||this.dispatchEvent(new Event(`${B}-dragenter`,{bubbles:!0,composed:!0}))};#o=t=>{if(t.preventDefault(),this.disabled){t.dataTransfer.dropEffect="none";return}t.dataTransfer.dropEffect="copy",this.#t&&(this.#t.classList.add("dropzone--dragover"),this.#t.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${B}-dragover`,{bubbles:!0,composed:!0}))};#l=()=>{this.disabled||(this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${B}-dragleave`,{bubbles:!0,composed:!0})))};#i=async t=>{if(!this.disabled){t.preventDefault(),this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover"));try{this.#b(await I(t))}catch(t){this.dispatchEvent(new CustomEvent(`${B}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}};#c=()=>{this.disabled||this.#e?.click()};#r=t=>{this.disabled||" "!==t.key&&"Enter"!==t.key||this.#e?.click()};#b(t){if(!Array.isArray(t)||!t.length)return;let e=[],i=[],o=t.length;if(!this.multiple&&o>1)for(let e of t)i.push({file:e,errors:[{code:F,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&o>this.maxFiles)for(let e of t)i.push({file:e,errors:[{code:F,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let o of t){let t=function(t,e=""){if(!e)return!0;let i=[...new Set(e.split(",").map(t=>t.trim()).filter(Boolean))],o=t.type,s=o.replace(/\/.*$/,"");for(let e of i)if("."===e.charAt(0)){if(-1!==t.name.toLowerCase().indexOf(e.toLowerCase(),t.name.length-e.length))return!0}else if(/\/\*$/.test(e)){if(s===e.replace(/\/.*$/,""))return!0}else if(o===e)return!0;return!1}(o,this.accept),s=o.size>this.maxSize,r=o.size<this.minSize;if(!t||s||r){let e=[];t||e.push({code:"INVALID_MIME_TYPE",message:`File type "${o.type}" is not accepted.`}),s&&e.push({code:"FILE_TOO_LARGE",message:`File size ${o.size} exceeds the maximum size of ${this.maxSize}.`}),r&&e.push({code:"FILE_TOO_SMALL",message:`File size ${o.size} is smaller than the minimum size of ${this.minSize}.`}),i.push({file:o,errors:e})}else e.push(o)}this.dispatchEvent(new CustomEvent(`${B}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e,rejectedFiles:i}})),e.length>0&&this.dispatchEvent(new CustomEvent(`${B}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e}})),i.length>0&&this.dispatchEvent(new CustomEvent(`${B}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:i}})),this.#e&&(this.#e.value=this.#e.defaultValue)}openFileDialog(){this.disabled||this.#e?.click()}#s(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=B){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,j)}}function H(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}function P(t,e,i){if(!e.has(t))throw TypeError("attempted to "+i+" private field on non-instance");return e.get(t)}function U(t,e){var i;return(i=P(t,e,"get")).get?i.get.call(t):i.value}function V(t,e){if(e.has(t))throw TypeError("Cannot initialize the same private elements twice on an object")}function W(t,e,i){V(t,e),e.set(t,i)}function G(t,e,i){return function(t,e,i){if(e.set)e.set.call(t,i);else{if(!e.writable)throw TypeError("attempted to set read only private field");e.value=i}}(t,P(t,e,"set"),i),i}function Z(t,e,i){if(!e.has(t))throw TypeError("attempted to get private field on non-instance");return i}function K(t,e){V(t,e),e.add(t)}j.defineCustomElement(),Object.defineProperty({},"ResizeObserverElement",{get:function(){return tr},set:t,enumerable:!0,configurable:!0});let Y=document.createElement("template"),X=String.raw;Y.innerHTML=X`
  <style>:host { display: contents; }</style>
  <slot></slot>
`;var J=new WeakMap,Q=new WeakMap,tt=new WeakMap,te=new WeakSet,ti=new WeakSet,to=new WeakMap,ts=new WeakSet;class tr extends HTMLElement{static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,i){"disabled"===t&&e!==i&&(this.disabled?Z(this,ti,ta).call(this):Z(this,te,tn).call(this))}connectedCallback(){Z(this,ts,tl).call(this,"disabled"),"ResizeObserver"in window&&(G(this,Q,new ResizeObserver(t=>{this.dispatchEvent(new CustomEvent("resize-observer:resize",{bubbles:!0,composed:!0,detail:{entries:t}}))})),this.disabled||Z(this,te,tn).call(this),U(this,J).addEventListener("slotchange",U(this,to)))}disconnectedCallback(){Z(this,ti,ta).call(this),U(this,J).removeEventListener("slotchange",U(this,to))}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}static defineCustomElement(t="resize-observer"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tr)}constructor(){super(),K(this,te),K(this,ti),K(this,ts),W(this,J,{writable:!0,value:void 0}),W(this,Q,{writable:!0,value:void 0}),W(this,tt,{writable:!0,value:void 0}),W(this,to,{writable:!0,value:()=>{this.disabled||Z(this,te,tn).call(this)}}),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Y.content.cloneNode(!0))),G(this,J,this.shadowRoot.querySelector("slot")),G(this,Q,null),G(this,tt,[])}}function tn(){U(this,J)&&U(this,Q)&&(U(this,tt).forEach(t=>U(this,Q).unobserve(t)),G(this,tt,[]),U(this,J).assignedElements().forEach(t=>{U(this,Q).observe(t),U(this,tt).push(t)}))}function ta(){U(this,Q)&&U(this,Q).disconnect()}function tl(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}tr.defineCustomElement();let td=(t,e,i)=>(Number.isNaN(e)&&(e=0),Number.isNaN(i)&&(i=0),Math.min(Math.max(t,Math.min(e,i)),Math.max(e,i))),tc="capture-photo",th=`
  :host {
    display: block;
    box-sizing: border-box;
  }
...
`;class tp extends HTMLElement{#t={};#e=null;#n=null;#s=null;#l=null;#o=null;#i=null;#a=null;#r=null;constructor(){super(),this.#t=this.getSupportedConstraints(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tu.content.cloneNode(!0))}static get observedAttributes(){return["no-image","facing-mode","camera-resolution","pan","tilt","zoom"]}attributeChangedCallback(t,e,i){if(!this.isConnected)return;let o=this.getTrackCapabilities(),s=this.getTrackSettings();if("no-image"===t&&e!==i&&this.#p(),"facing-mode"===t&&e!==i&&"facingMode"in this.#t){let t=["user","environment"].includes(this.facingMode||"");"facingMode"in s&&t&&(this.stopVideoStream(),this.startVideoStream())}if("camera-resolution"===t&&e!==i&&"string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,e=0]=this.cameraResolution.split("x").map(t=>Number(t));if(t>0&&e>0&&"width"in o&&"height"in o){let i=!!(o.width?.min&&o.width?.max)&&t>=o?.width?.min&&t<=o?.width?.max,r=!!(o.height?.min&&o.height?.max)&&e>=o?.height?.min&&e<=o?.height?.max;"width"in s&&"height"in s&&i&&r&&(this.stopVideoStream(),this.startVideoStream())}}if("pan"===t&&e!==i&&"pan"in this.#t){let t=!!("pan"in o&&o.pan?.min&&o.pan?.max)&&this.pan>=o.pan.min&&this.pan<=o.pan.max;"pan"in s&&"number"==typeof this.pan&&t&&this.#h("pan",this.pan)}if("tilt"===t&&e!==i&&"tilt"in this.#t){let t=!!("tilt"in o&&o.tilt?.min&&o.tilt?.max)&&this.tilt>=o.tilt.min&&this.tilt<=o.tilt.max;"tilt"in s&&"number"==typeof this.tilt&&t&&this.#h("tilt",this.tilt)}if("zoom"===t&&e!==i&&"zoom"in this.#t){let t=!!("zoom"in o&&o.zoom?.min&&o.zoom?.max)&&this.zoom>=o.zoom.min&&this.zoom<=o.zoom.max;"zoom"in s&&"number"==typeof this.zoom&&t&&this.#h("zoom",this.zoom)}}connectedCallback(){if(this.#c("autpoPlay"),this.#c("noImage"),this.#c("facingMode"),this.#c("cameraResolution"),this.#c("pan"),this.#c("tilt"),this.#c("zoom"),this.#c("calculateFileSize"),this.#n=this.shadowRoot?.querySelector("canvas")||null,this.#s=this.shadowRoot?.getElementById("output")||null,this.#l=this.shadowRoot?.querySelector("video")||null,this.#o=this.shadowRoot?.querySelector('slot[name="capture-button"]')||null,this.#i=this.#d(),this.#a=this.shadowRoot?.querySelector('slot[name="facing-mode-button"]')||null,this.#r=this.#g(),this.#l?.addEventListener("loadedmetadata",this.#b),this.#o?.addEventListener("slotchange",this.#m),this.#i?.addEventListener("click",this.#u),this.#a?.addEventListener("slotchange",this.#v),this.#r?.addEventListener("click",this.#f),!tp.isSupported())return this.dispatchEvent(new CustomEvent(`${tc}:error`,{bubbles:!0,composed:!0,detail:{error:{name:"NotSupportedError",message:"Not supported"}}}));this.autoPlay&&this.startVideoStream()}disconnectedCallback(){this.stopVideoStream(),this.#r?.removeEventListener("click",this.#f),this.#i?.removeEventListener("click",this.#u),this.#l?.removeEventListener("canplay",this.#b),this.#o?.removeEventListener("slotchange",this.#m),this.#a?.removeEventListener("slotchange",this.#v)}get autoPlay(){return this.hasAttribute("auto-play")}set autoPlay(t){this.toggleAttribute("auto-play",!!t)}get noImage(){return this.hasAttribute("no-image")}set noImage(t){this.toggleAttribute("no-image",!!t)}get facingMode(){return this.getAttribute("facing-mode")||"user"}set facingMode(t){this.setAttribute("facing-mode",t)}get cameraResolution(){return this.getAttribute("camera-resolution")||""}set cameraResolution(t){this.setAttribute("camera-resolution",t)}get pan(){return Number(this.getAttribute("pan"))||0}set pan(t){this.setAttribute("pan",null!=t?t.toString():t)}get tilt(){return Number(this.getAttribute("tilt"))||0}set tilt(t){this.setAttribute("tilt",null!=t?t.toString():t)}get zoom(){return Number(this.getAttribute("zoom"))||1}set zoom(t){this.setAttribute("zoom",null!=t?t.toString():t)}get loading(){return this.hasAttribute("loading")}get calculateFileSize(){return this.hasAttribute("calculate-file-size")}set calculateFileSize(t){this.toggleAttribute("calculate-file-size",!!t)}#f=t=>{t.preventDefault(),this.loading||(this.facingMode="user"!==this.facingMode&&this.facingMode?"user":"environment")};#u=t=>{t.preventDefault(),this.capture()};#b=t=>{let e=t.target;e.play().then(()=>{this.dispatchEvent(new CustomEvent(`${tc}:video-play`,{bubbles:!0,composed:!0,detail:{video:e}}))}).catch(t=>{this.dispatchEvent(new CustomEvent(`${tc}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}).finally(()=>{this.removeAttribute("loading")})};#p(){this.#s&&Array.from(this.#s.childNodes).forEach(t=>t.remove())}#h(t,e){if(!this.#e||!t||!e)return;let[i]=this.#e.getVideoTracks(),o=this.getTrackCapabilities();t in this.getTrackSettings()&&i.applyConstraints({advanced:[{[t]:td(Number(e),o[t]?.min||1,o[t]?.max||1)}]})}#m=t=>{t.target?.name==="capture-button"&&(this.#i?.removeEventListener("click",this.#u),this.#i=this.#d(),this.#i&&(this.#i.addEventListener("click",this.#u),"BUTTON"===this.#i.nodeName||this.#i.hasAttribute("role")||this.#i.setAttribute("role","button")))};#v=t=>{t.target?.name==="facing-mode-button"&&(this.#r?.removeEventListener("click",this.#f),this.#r=this.#g(),this.#r&&(this.#r.addEventListener("click",this.#f),"BUTTON"===this.#r.nodeName||this.#r.hasAttribute("role")||this.#r.setAttribute("role","button")))};#g(){return this.#a&&this.#a.assignedElements({flatten:!0}).find(t=>"BUTTON"===t.nodeName||"facing-mode-button"===t.getAttribute("slot"))||null}#d(){return this.#o&&this.#o.assignedElements({flatten:!0}).find(t=>"BUTTON"===t.nodeName||"capture-button"===t.getAttribute("slot"))||null}#c(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}async startVideoStream(){if(!tp.isSupported()||this.#e)return;this.setAttribute("loading","");let t={video:{facingMode:{ideal:this.facingMode||"user"},pan:!0,tilt:!0,zoom:!0},audio:!1};if("string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[e=0,i=0]=this.cameraResolution.split("x").map(t=>Number(t));e>0&&i>0&&(t.video.width=e,t.video.height=i)}try{this.#e=await navigator.mediaDevices.getUserMedia(t),this.#l&&(this.#l.srcObject=this.#e),this.#h("pan",this.pan),this.#h("tilt",this.tilt),this.#h("zoom",this.zoom);let e=this.getTrackSettings();"facingMode"in e&&this.#a&&(this.#a.hidden=!1)}catch(t){this.dispatchEvent(new CustomEvent(`${tc}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}finally{this.removeAttribute("loading")}}stopVideoStream(){if(!this.#l||!this.#e)return;let[t]=this.#e.getVideoTracks();t?.stop(),this.#l.srcObject=null,this.#e=null}async capture(){if(!this.loading&&this.#n&&this.#l)try{let t=this.#n.getContext("2d"),e=this.#l.videoWidth,i=this.#l.videoHeight;this.#n.width=e,this.#n.height=i,t?.drawImage(this.#l,0,0,e,i);let o=this.#n.toDataURL("image/png");if("string"==typeof o&&o.includes("data:image")){if(!this.noImage){let t=new Image;t.src=o,t.width=e,t.height=i,t.setAttribute("part","output-image"),this.#p(),this.#s?.appendChild(t)}let t={dataURI:o,width:e,height:i};if(this.calculateFileSize)try{let e=await fetch(o),i=(await e.blob()).size;i&&(t.size=i)}catch(t){}this.dispatchEvent(new CustomEvent(`${tc}:success`,{bubbles:!0,composed:!0,detail:t}))}}catch(t){this.dispatchEvent(new CustomEvent(`${tc}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}getSupportedConstraints(){return tp.isSupported()&&navigator.mediaDevices.getSupportedConstraints()||{}}getTrackCapabilities(){if(!this.#e)return{};let[t]=this.#e.getVideoTracks();return t&&"function"==typeof t.getCapabilities&&t.getCapabilities()||{}}getTrackSettings(){if(!this.#e)return{};let[t]=this.#e.getVideoTracks();return t&&"function"==typeof t.getSettings&&t.getSettings()||{}}static isSupported(){return!!navigator.mediaDevices?.getUserMedia}static defineCustomElement(t=tc){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tp)}}let tb="No barcode detected",tm=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"];function tg(t){return new Promise(function(e,i){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return i(t.error)}})}function tf(){if(!e){var t,i,o,s;t="keyval-store",i="keyval",(o=indexedDB.open(t)).onupgradeneeded=function(){return o.result.createObjectStore(i)},s=tg(o),e=function(t,e){return s.then(function(o){return e(o.transaction(i,t).objectStore(i))})}}return e}let tv="barcode-scanner/",tw="settings",ty="history",tE=async t=>{try{return{value:await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:tf();return e("readonly",function(e){return tg(e.get(t))})}(t),error:void 0}}catch(t){return{value:void 0,error:t}}},tA=async(t,e)=>{try{return await function(t,e){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:tf();return i("readwrite",function(i){return i.put(e,t),tg(i.transaction)})}(t,e),{error:void 0}}catch(t){return{error:t}}},tx=async()=>tE(tv+tw),tz=async t=>tA(tv+tw,t),tS=async()=>tE(tv+ty),tC=async t=>tA(tv+ty,t),tT=(t,e=0,i=!1)=>{let o=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...s)=>{clearTimeout(o),i&&!o&&t(...s),o=setTimeout(()=>{o=null,i||t(...s)},e)}};function tk(t){let e=document.getElementById("historyList"),i=document.getElementById("emptyHistoryBtn");e.innerHTML="",Array.isArray(t)&&0!==t.length?(i.hidden=!1,t.forEach(t=>{let i;let o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(i=document.createElement("a")).href=t,i.setAttribute("target","_blank"),i.setAttribute("rel","noreferrer noopener")}catch{i=document.createElement("span")}i.textContent=t,i.setAttribute("title",t);let s=document.createElement("div");s.className="history-modal__actions";let r=document.createElement("custom-clipboard-copy");r.title="Copy to clipboard",r.setAttribute("only-icon",""),r.setAttribute("value",t),s.appendChild(r);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.title="Remove from history",n.setAttribute("data-action","delete"),n.innerHTML=`
        ...
        `,s.appendChild(n),o.appendChild(i),o.appendChild(s),e.appendChild(o)})):(e.innerHTML="<li>There are no saved items in history.</li>",i.hidden=!0)}async function tL(t){let{value:e}=await tx();if(!t||!e?.addToHistory)return;let{value:i=[],error:o}=await tS();if(!o&&!i.find(e=>e===t)){let e=[...i,t],{error:o}=await tC(e);o||tk(e)}}async function t_(t){if(!t)return;let{value:e=[],error:i}=await tS();if(!i){let i=e.filter(e=>e!==t),{error:o}=await tC(i);o||tk(i)}}async function tR(){let{error:t}=await tC([]);t||tk([])}async function tN(t,e){if(!t||!e)return;e.querySelector(".results__item")?.remove();try{let{value:i}=await tx();new URL(t),window.open(t,"_blank");let o=document.createElement("a");o.href=t,o.className="results__item",o.textContent=t,i?.openWebPageSameTab||(o.setAttribute("target","_blank"),o.setAttribute("rel","noreferrer noopener")),e.insertBefore(o,e.querySelector(".results__actions"))}catch{let i=document.createElement("span");i.className="results__item results__item--no-barcode",i.textContent=t,e.insertBefore(i,e.querySelector(".results__actions"))}e.show();let i=e.querySelector("custom-clipboard-copy"),o=e.querySelector("web-share"),s=t!==tb;i&&(i.disabled=!s,i.hidden=!s),o&&H()&&(o.disabled=!s,o.hidden=!s,s?o.setAttribute("share-text",t):o.removeAttribute("share-text"))}let tM=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:i,frequency:o,volume:s,type:r,onEnded:n}=e,a=t.createOscillator(),l=t.createGain();a.connect(l),l.connect(t.destination),s&&(l.gain.value=s),o&&(a.frequency.value=o),r&&(a.type=r),"function"==typeof n&&(a.onended=n),a.start(t.currentTime),a.stop(t.currentTime+(i||500)/1e3)}})();async function tO(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}async function tq(){let{value:t}=await tx();t&&(t.beep&&tM({duration:200,frequency:860,volume:.03,type:"square"}),t.vibrate&&tO(100))}function tI(t,e){if(!t||!e)return;let i=t.getBoundingClientRect();e.style.cssText=`width: ${i.width}px; height: ${i.height}px`}class tB{static async polyfill(){if(!("BarcodeDetector"in window))try{await r("bkcP3")}catch{throw Error("BarcodeDetector API is not supported by your browser.")}}static async getSupportedFormats(){return await window.BarcodeDetector.getSupportedFormats()}static async create(){return new tB(await window.BarcodeDetector.getSupportedFormats())}static async init(){try{await tB.polyfill();let t=await tB.create(),e=await tB.getSupportedFormats();return{barcodeReader:t,barcodeFormats:e,barcodeReaderError:null}}catch(t){return{barcodeReader:null,barcodeFormats:[],barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0)return e[0];throw Error("Could not detect barcode from provided source.")}}async function tF(t){let{value:e={}}=await tx();Object.entries(e).forEach(([e,i])=>{let o=t.querySelector(`[name="${e}"]`);o&&(o.checked=i)})}let t$="clipboard-copy",tD="success",tj="error",tH=document.createElement("template");tH.innerHTML=`
  <style>
    :host([hidden]),
    [hidden],
    ::slotted([hidden]) {
...
`;class tP extends HTMLElement{#t=null;#e;#s;#i;#n;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tH.content.cloneNode(!0))),this.#e=this.shadowRoot.querySelector("button"),this.#s=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#n=this.shadowRoot.querySelector('slot[name="error"]')}static get observedAttributes(){return["disabled"]}connectedCallback(){this.#a("value"),this.#a("from"),this.#a("disabled"),this.#a("feedbackDuration"),this.#e.addEventListener("click",this.#l)}disconnectedCallback(){this.#e.removeEventListener("click",this.#l),this.#o()}attributeChangedCallback(t){"disabled"===t&&(this.#e.disabled=this.disabled,this.#e.setAttribute("aria-disabled",this.disabled.toString()),this.#e.part.contains("button")&&this.#e.part.toggle("button--disabled",this.disabled))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}get from(){return this.getAttribute("from")}set from(t){this.setAttribute("from",t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",t)}async #r(){if(this.value||this.from)try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#e.getRootNode({composed:!0}):this.#e.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;t=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?i.href:i.textContent}await navigator.clipboard.writeText(t),this.#c(tD),this.dispatchEvent(new CustomEvent(`${t$}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tj),this.dispatchEvent(new CustomEvent(`${t$}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#l=t=>{t.preventDefault(),this.disabled||this.#t||this.#r()};#c(t){this.#s.hidden=!0,this.#i.hidden=t!==tD,this.#n.hidden=t!==tj,this.#e.part.remove("button--success"),this.#e.part.remove("button--error"),this.#e.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#s.hidden=!1,this.#i.hidden=!0,this.#n.hidden=!0,this.#e.part.remove(`button--${t}`),this.#t=null},this.feedbackDuration)}#o(){this.#t&&clearTimeout(this.#t),this.#t=null,this.#s.hidden=!1,this.#i.hidden=!0,this.#n.hidden=!0,this.#e.part.remove("button--success"),this.#e.part.remove("button--error")}#a(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=t$){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tP)}}class tU extends tP{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
      <svg xmlns="http://www.w3.org/2000/svg" width="1.125em" height="1.125em" fill="currentColor" viewBox="0 0 16 16">
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#C("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#C(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tU)}}tU.defineCustomElement(),async function(){let t;let e=document.querySelector("a-tab-group"),i=document.getElementById("cameraPanel"),o=document.querySelector("capture-photo"),s=document.getElementById("cameraResults"),r=document.getElementById("fileResults"),n=document.getElementById("scanInstructions"),a=document.getElementById("scanBtn"),l=document.getElementById("dropzone"),d=document.querySelector("resize-observer"),c=document.getElementById("scanFrame"),h=document.getElementById("globalActions"),u=document.getElementById("historyBtn"),p=document.getElementById("historyDialog"),b=document.getElementById("settingsBtn"),m=document.getElementById("settingsDialog"),g=document.forms["settings-form"],f=!0,{barcodeReader:v,barcodeFormats:w,barcodeReaderError:y}=await tB.init();if(y){let t=document.getElementById("barcodeReaderError");f=!1,h.hidden=!0,e.hidden=!0,t.hidden=!1,t.textContent=y?.message;return}o.addEventListener("capture-photo:video-play",function(t){c.hidden=!1,tI(t.detail.video,c),A();let e=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),s=document.getElementById("zoomLevel");if(e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),r=i?.zoom?.min||0,n=i?.zoom?.max||10,a=e?.zoom||1;t.hidden=!1,s.textContent=a,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&a<n&&(a+=.5),i&&a>r&&(a-=.5),s.textContent=a,o.zoom=a})}},{once:!0}),o.addEventListener("capture-photo:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;i.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tp.defineCustomElement();let E=o?.shadowRoot?.querySelector("video");async function A(){n.hidden=!1;try{let e=await v.detect(E),i=e?.rawValue??"";if(!i)throw Error(tb);window.cancelAnimationFrame(t);let o=`https://form.gov.sg/66b9dceb205668337d25786e?66ba2d7b81b299b7d5c5cc64=${i}`;x(s),tN(i,s),tL(i);let r=document.createElement("button");r.textContent="Open Scanned URL",r.className="centered-button",r.addEventListener("click",()=>{window.open(o,"_blank")}),s.appendChild(r),n.hidden=!0,a.hidden=!1,c.hidden=!0,tq()}catch{f&&(t=window.requestAnimationFrame(()=>A()))}}function x(t){t&&(t.querySelectorAll(".results__item, button").forEach(t=>t.remove()),t.close())}l.accept=tm.join(","),tF(g),function(t){if(!Array.isArray(t)||0===t.length)return;let e=document.getElementById("supportedFormats");e&&(e.textContent=`Supported formats: ${t.join(", ")}`)}(w),tk((await tS()).value||[]),H()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0}),a.addEventListener("click",function(){x(s),a.hidden=!0,c.hidden=!1,A()}),e.addEventListener("a-tab-show",tT(handleTabShow,250)),l.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,i=new FileReader;i.onload=i=>{let o=i.target.result;e.onload=async()=>{try{let t=await v.detect(e),i=t?.rawValue??"";if(!i)throw Error(tb);tN(i,r),tL(i),tq()}catch(t){tN(tb,r)}},e.src=o,e.alt="Image preview",l.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let a=document.createElement("div");a.className="dropzone-preview__file-name",a.textContent=t.name,n.appendChild(e),s.appendChild(n),s.appendChild(a),l.prepend(s)},i.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),d.addEventListener("resize-observer:resize",function(){tI(o.shadowRoot.querySelector("video"),c)}),b.addEventListener("click",function(){m.showModal()}),m.addEventListener("click",function(t){t.target===t.currentTarget&&m.close()}),g.addEventListener("change",function(t){let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tz(e)}),u.addEventListener("click",function(){p.showModal()}),p.addEventListener("click",function(t){let e=t.target;if(e===t.currentTarget){p.close();return}if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;if(window.confirm(`Delete ${t}?`)){t_(t);return}}if(e.closest("#emptyHistoryBtn")&&window.confirm("Are you sure you want to empty history?")){tR();return}}),document.addEventListener("visibilitychange",function(){if("cameraTab"===e.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)f=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream();else{f=!0;let t=document.querySelector("capture-photo");if(!t)return;t.loading||s.querySelector(".results__item")||A(),"function"==typeof t.startVideoStream&&t.startVideoStream()}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=e.querySelector("#cameraTab").hasAttribute("selected"),i=!a.hidden,o=m.hasAttribute("open"),s=p.hasAttribute("open");i&&t&&!(o||s)&&a.click()}()})}()}();
//# sourceMappingURL=index.26afe28d.js.map
